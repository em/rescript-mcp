...
- GitHub Actions runs `npm run release:ci` with trusted publishing and provenance only when the owner has explicitly enabled the publish step for the current release stage.
